...
+ (UIColor*)whiteColorWithHexAlpha:(NSInteger)alphaValue
{
    
    return [UIColor colorWithHex:0xffffff alpha:alphaValue/255.0];
}
...
+ (UIColor*)blackColorWithHexAlpha:(NSInteger)alphaValue
{
    return [UIColor colorWithHex:0x000000 alpha:alphaValue/255.0];
}
