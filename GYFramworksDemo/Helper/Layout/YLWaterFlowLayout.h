...
@optional
-(CGFloat)waterFlowLayout:(YLWaterFlowLayout *)layout headerHeightAtIndexPath:(NSIndexPath *)indexPath;

-(CGFloat)waterFlowLayout:(YLWaterFlowLayout *)layout footerHeightAtIndexPath:(NSIndexPath *)indexPath;
@end
